  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              ...
              className="rounded-lg bg-[#25D366] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1da851]"
            >
              💬 Coba via WhatsApp
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20" id="harga">
        <h2 className="mb-4 text-center text-3xl font-extrabold">Lebih murah dari 1 staf admin</h2>
        <p className="mb-12 text-center text-[var(--text-secondary)]">
          ROI positif dari hari pertama. Coba gratis 14 hari.
        </p>
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-white p-8">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)]">Untuk WP individu</p>
            <ul className="mt-6 space-y-3">
              {["Kalkulator PPh 21", "3 dokumen OCR/bulan via WA", "Tanya jawab pajak"].map((f) => (
                <li key={f} className="flex items-start gap-2 text-sm"><span className="text-[var(--accent)]">✓</span>{f}</li>
              ))}
            </ul>
            <Link href="https://wa.me/628131102445?text=Halo%20Pajakia" className="mt-8 block rounded-lg border border-[var(--border)] py-3 text-center font-semibold hover:border-[var(--primary)] hover:text-[var(--primary)] transition-colors">
              Mulai via WhatsApp
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-white p-8">
            ...
            <div className="mt-2 flex items-baseline gap-1">
              ...
              <span className="text-sm text-[var(--text-secondary)]">/SPT</span>
            </div>
            <p className="mt-2 text-sm text-[var(--text-secondary)]">Karyawan & freelancer</p>
            <ul className="mt-6 space-y-3">
              {["Semua fitur Gratis", "SPT 1770S/1770SS lengkap", "OCR unlimited via WhatsApp", "Export PDF & Coretax CSV"].map((f) => (
                <li key={f} className="flex items-start gap-2 text-sm"><span className="text-[var(--accent)]">✓</span>{f}</li>
              ))}
            </ul>
            <Link href="https://wa.me/628131102445?text=Mau%20paket%20Personal" className="mt-8 block rounded-lg border border-[var(--border)] py-3 text-center font-semibold hover:border-[var(--primary)] hover:text-[var(--primary)] transition-colors">
              Mulai via WhatsApp
            </Link>
          </div>
          ...
          <div className="rounded-2xl border-2 border-[var(--primary)] bg-blue-50 p-8 shadow-lg relative">
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)]">Hingga 100 klien</p>
            <ul className="mt-6 space-y-2.5">
              {[
                "WhatsApp OCR otomatis untuk klien",
                "Dashboard multi-klien + Kanban",
                "Portal upload self-service",
                "Notifikasi real-time ke WA Anda",
                "Auto-generate semua jenis SPT",
                "Batch processing 50+ dokumen",
                "Deadline tracker + auto-reminder",
                "Invoice & revenue tracking",
                "2FA + enkripsi + audit log",
                "e-Bupot & e-Faktur CSV",
              ].map((f) => (
                <li key={f} className="flex items-start gap-2 text-sm"><span className="text-[var(--accent)]">✓</span>{f}</li>
              ))}
            </ul>
            <Link
              href="https://wa.me/628131102445?text=Saya%20konsultan%20pajak%2C%20mau%20coba%20Pajakia"
              className="mt-8 flex items-center justify-center gap-2 rounded-lg bg-[var(--primary)] py-3 font-semibold text-white hover:bg-[var(--primary-dark)] transition-colors"
            >
        ...
        <div className="mx-auto mt-12 max-w-2xl rounded-2xl border border-[var(--border)] bg-white p-8 text-center">
          <h3 className="text-lg font-bold">Hitung ROI</h3>
          <p className="mt-2 text-sm text-[var(--text-secondary)]">
            50 klien x Rp 1jt/klien = <strong className="text-[var(--text)]">Rp 50jt/bulan revenue</strong>.
            Pajakia = <strong className="text-[var(--text)]">Rp 500rb</strong> = <strong className="text-[var(--accent)]">1% dari revenue</strong>.
            Menghemat 80% waktu admin = kapasitas untuk <strong className="text-[var(--text)]">tambah 50 klien lagi</strong>.
          </p>
        </div>
      </section>
