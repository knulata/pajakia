      ...
      <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm">
        ...
        <div className="p-6 space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-[var(--border)] p-4"><div className="text-sm font-medium">Transfer Data</div><div className="mt-1 text-xs text-[var(--text-secondary)]">Sesuai UU PDP — dengan consent, safeguard kontraktual, dan enkripsi in-transit</div><span className="mt-2 inline-block rounded-full bg-green-100 px-2 py-0.5 text-xs font-semibold text-green-800">Compliant</span></div>
